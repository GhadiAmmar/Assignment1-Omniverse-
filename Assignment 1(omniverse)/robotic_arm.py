...
add_component("lower_arm", "lower_arm.usda", (0, 1.5, 0), rotate=(0, 0, 0), scale=(1, 1, 1))
add_component("upper_arm", "upper_arm.usda", (0, 3.5, 0), rotate=(0, 0, 0), scale=(1, 1, 1))
add_component("gripper", "gripper.usda", (0, 5.5, 0), rotate=(0, 0, 0), scale=(1, 1, 1))